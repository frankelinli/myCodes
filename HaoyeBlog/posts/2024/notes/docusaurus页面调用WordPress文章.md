...
![image-20250918081417233](https://haoyeblog-1319658309.cos.ap-guangzhou.myqcloud.com/image-20250918081417233.png)

:::tip

其实，从任何页面都可以调用WordPress 文章，通过REST API通道，获取文章，然后展示在本地、展示在网页，展示在手机APP里都可以。
